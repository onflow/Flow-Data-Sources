# Source: https://github.com/onflow/flow-core-contracts/blob/master/transactions/flowToken/create_forwarder.cdc
...
transaction(receiver: Address) {
    ...
    prepare(acct: auth(BorrowValue, Capabilities) &Account) {
        ...
        acct.storage.save(<-vault, to: /storage/flowTokenForwarder)
