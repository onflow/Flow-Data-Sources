...
## What is Cadence?[​](#what-is-cadence "Direct link to What is Cadence?")
...
* Built-in pre-conditions and post-conditions for functions and [transactions](/docs/language/transactions)
...
Please see the [Cadence introduction](/docs/) for more information about the high level design of the language.

## What is the Flow Developer Playground?[​](#what-is-the-flow-developer-playground "Direct link to What is the Flow Developer Playground?")
...
## Getting to know the Playground[​](#getting-to-know-the-playground "Direct link to Getting to know the Playground")
...
[Cadence is the premier resource-oriented programming language](/docs/)
for developing smart contracts and is currently
the primary smart contract programming language on the Flow Blockchain.

## Accounts and Contracts[​](#accounts-and-contracts "Direct link to Accounts and Contracts")
...
you can [create a smart contract](/docs/tutorial/hello-world) for Flow!

[Edit this page](https://github.com/onflow/cadence-lang.org/tree/main/docs/tutorial/01-first-steps.md)[PreviousWhy Use Cadence?](/docs/why)[Next2. Hello World](/docs/tutorial/hello-world)
###### Rate this page

😞😐😊

* [What is Cadence?](#what-is-cadence)
* [What is the Flow Developer Playground?](#what-is-the-flow-developer-playground)
* [Getting to know the Playground](#getting-to-know-the-playground)
