# Source: https://github.com/blocto/flow-transactions/blob/main/build/BloctoBay/shard/buy.testnet.cdc
...
transaction(listingResourceID: UInt64, storefrontAddress: Address, buyPrice: UFix64) {
    ...
    prepare(signer: AuthAccount) {
        ...
        if signer.borrow<&Shard.Collection>(from: /storage/EternalShardCollection) == nil {
            ...
            signer.link<&{NonFungibleToken.CollectionPublic, Shard.ShardCollectionPublic}>(
        ...
        self.nftCollection = signer.borrow<&{NonFungibleToken.Receiver}>(from: /storage/EternalShardCollection)
