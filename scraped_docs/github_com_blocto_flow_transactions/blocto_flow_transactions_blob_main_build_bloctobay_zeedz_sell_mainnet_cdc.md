# Source: https://github.com/blocto/flow-transactions/blob/main/build/BloctoBay/zeedz/sell.mainnet.cdc
...
transaction(saleItemID: UInt64, saleItemPrice: UFix64) {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftCollectionProviderPrivatePath = /private/ZeedzINOCollectionProviderForNFTStorefront
    ...
    execute {
        ...
        let requirements = Marketplace.getSaleCutRequirements(nftType: Type<@ZeedzINO.NFT>())
