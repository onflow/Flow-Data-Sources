# Source: https://github.com/blocto/flow-transactions/blob/main/build/BloctoBay/everbloom/buy.testnet.cdc
...
transaction(listingResourceID: UInt64, storefrontAddress: Address, buyPrice: UFix64) {
    ...
    prepare(signer: AuthAccount) {
        ...
        if signer.borrow<&Everbloom.Collection>(from: Everbloom.CollectionStoragePath) == nil {
            ...
            signer.link<&{NonFungibleToken.CollectionPublic, Everbloom.PrintCollectionPublic}>(
			    Everbloom.CollectionPublicPath,
			    target: Everbloom.CollectionStoragePath
		    )
        }
        ...
        self.nftCollection = signer.borrow<&{NonFungibleToken.Receiver}>(from: Everbloom.CollectionStoragePath)
