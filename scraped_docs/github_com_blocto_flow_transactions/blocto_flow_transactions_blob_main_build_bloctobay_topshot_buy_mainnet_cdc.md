# Source: https://github.com/blocto/flow-transactions/blob/main/build/BloctoBay/topShot/buy.mainnet.cdc
...
transaction(listingResourceID: UInt64, storefrontAddress: Address, buyPrice: UFix64) {
    ...
    prepare(signer: AuthAccount) {
        ...
        if signer.borrow<&TopShot.Collection>(from: /storage/MomentCollection) == nil {
            ...
            signer.link<&{NonFungibleToken.CollectionPublic, TopShot.MomentCollectionPublic}>(
        ...
        self.nftCollection = signer.borrow<&{NonFungibleToken.Receiver}>(from: /storage/MomentCollection)
