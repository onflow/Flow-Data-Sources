# Source: https://github.com/blocto/flow-transactions/blob/main/build/BloctoBay/starly/sell.mainnet.cdc
...
transaction(saleItemID: UInt64, saleItemPrice: UFix64) {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftCollectionProviderPrivatePath = /private/StarlyCardCollectionProviderForNFTStorefront
    ...
    execute {
        // Remove old listing
        if let listingID = Marketplace.getListingID(nftType: Type<@StarlyCard.NFT>(), nftID: saleItemID) {
        ...
        let requirements = Marketplace.getSaleCutRequirements(nftType: Type<@StarlyCard.NFT>())
