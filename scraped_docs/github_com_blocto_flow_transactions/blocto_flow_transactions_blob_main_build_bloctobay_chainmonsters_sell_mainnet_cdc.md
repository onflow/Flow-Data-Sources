# Source: https://github.com/blocto/flow-transactions/blob/main/build/BloctoBay/chainmonsters/sell.mainnet.cdc
...
transaction(saleItemID: UInt64, saleItemPrice: UFix64) {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftCollectionProviderPrivatePath = /private/ChainmonstersRewardsCollectionProviderForNFTStorefront
    ...
    execute {
        // Remove old listing
        if let listingID = Marketplace.getListingID(nftType: Type<@ChainmonstersRewards.NFT>(), nftID: saleItemID) {
        ...
        let requirements = Marketplace.getSaleCutRequirements(nftType: Type<@ChainmonstersRewards.NFT>())
