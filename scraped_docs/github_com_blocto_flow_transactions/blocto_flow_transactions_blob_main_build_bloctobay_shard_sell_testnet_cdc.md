# Source: https://github.com/blocto/flow-transactions/blob/main/build/BloctoBay/shard/sell.testnet.cdc
...
transaction(saleItemID: UInt64, saleItemPrice: UFix64) {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftCollectionProviderPrivatePath = /private/ShardCollectionProviderForNFTStorefront
    ...
    execute {
        // Remove old listing
        if let listingID = Marketplace.getListingID(nftType: Type<@Shard.NFT>(), nftID: saleItemID) {
        ...
        let requirements = Marketplace.getSaleCutRequirements(nftType: Type<@Shard.NFT>())
