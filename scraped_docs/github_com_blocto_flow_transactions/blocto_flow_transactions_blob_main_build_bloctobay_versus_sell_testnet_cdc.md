# Source: https://github.com/blocto/flow-transactions/blob/main/build/BloctoBay/versus/sell.testnet.cdc
...
transaction(saleItemID: UInt64, saleItemPrice: UFix64) {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftCollectionProviderPrivatePath = /private/ArtCollectionProviderForNFTStorefront
        if !signer.getCapability<&Art.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic}>(nftCollectionProviderPrivatePath)!.check() {
            signer.link<&Art.Collection{NonFungibleToken.Provider, NonFungibleToken.CollectionPublic}>(nftCollectionProviderPrivatePath, target: Art.CollectionStoragePath)
        }
