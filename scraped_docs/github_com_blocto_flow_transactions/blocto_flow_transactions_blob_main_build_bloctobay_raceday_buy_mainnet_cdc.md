# Source: https://github.com/blocto/flow-transactions/blob/main/build/BloctoBay/raceDay/buy.mainnet.cdc
...
transaction(listingResourceID: UInt64, storefrontAddress: Address, buyPrice: UFix64) {
    ...
    prepare(signer: AuthAccount) {
        ...
        if signer.borrow<&RaceDay_NFT.Collection>(from: RaceDay_NFT.CollectionStoragePath) == nil {
            ...
            signer.link<&{NonFungibleToken.CollectionPublic, RaceDay_NFT.RaceDay_NFTCollectionPublic}>(
        ...
        self.nftCollection = signer.borrow<&{NonFungibleToken.Receiver}>(from: RaceDay_NFT.CollectionStoragePath)
