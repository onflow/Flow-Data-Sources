# Source: https://github.com/blocto/flow-transactions/blob/main/build/BloctoBay/versus/buy.mainnet.cdc
...
transaction(listingResourceID: UInt64, storefrontAddress: Address, buyPrice: UFix64) {
    ...
    prepare(signer: AuthAccount) {
        ...
        if signer.borrow<&Art.Collection>(from: Art.CollectionStoragePath) == nil {
            ...
            signer.link<&{Art.CollectionPublic, NonFungibleToken.CollectionPublic}>(
        ...
        self.nftCollection = signer.borrow<&{NonFungibleToken.Receiver}>(from: Art.CollectionStoragePath)
