# Source: https://github.com/blocto/flow-transactions/blob/main/build/BloctoBay/topShot/sell.testnet.cdc
...
transaction(saleItemID: UInt64, saleItemPrice: UFix64) {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftCollectionProviderPrivatePath = /private/TopShotCollectionProviderForNFTStorefront
    ...
    execute {
        // Remove old listing
        if let listingID = Marketplace.getListingID(nftType: Type<@TopShot.NFT>(), nftID: saleItemID) {
        ...
        let requirements = Marketplace.getSaleCutRequirements(nftType: Type<@TopShot.NFT>())
