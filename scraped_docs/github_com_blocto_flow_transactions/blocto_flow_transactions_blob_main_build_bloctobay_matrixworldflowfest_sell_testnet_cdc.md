# Source: https://github.com/blocto/flow-transactions/blob/main/build/BloctoBay/matrixWorldFlowFest/sell.testnet.cdc
...
transaction(saleItemID: UInt64, saleItemPrice: UFix64) {
    ...
    prepare(signer: AuthAccount) {
        ...
        let nftCollectionProviderPrivatePath = /private/MatrixWorldFlowFestNFTCollectionProviderForNFTStorefront
    ...
    execute {
        // Remove old listing
        if let listingID = Marketplace.getListingID(nftType: Type<@MatrixWorldFlowFestNFT.NFT>(), nftID: saleItemID) {
        ...
        let requirements = Marketplace.getSaleCutRequirements(nftType: Type<@MatrixWorldFlowFestNFT.NFT>())
