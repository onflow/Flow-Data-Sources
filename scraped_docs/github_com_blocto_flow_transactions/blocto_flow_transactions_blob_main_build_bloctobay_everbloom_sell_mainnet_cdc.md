# Source: https://github.com/blocto/flow-transactions/blob/main/build/BloctoBay/everbloom/sell.mainnet.cdc
...
transaction(saleItemID: UInt64, saleItemPrice: UFix64) {
    ...
    execute {
        // Remove old listing
        if let listingID = Marketplace.getListingID(nftType: Type<@Everbloom.NFT>(), nftID: saleItemID) {
        ...
        let requirements = Marketplace.getSaleCutRequirements(nftType: Type<@Everbloom.NFT>())
