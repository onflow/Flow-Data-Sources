# Source: https://github.com/blocto/flow-transactions/blob/main/transactions/BloctoBay/zeedz/buy.cdc
...
import ZeedzINO from 0xZEEDZ_INO_ADDRESS
...
transaction(listingResourceID: UInt64, storefrontAddress: Address, buyPrice: UFix64) {
    ...
    prepare(signer: AuthAccount) {
        ...
        self.nftCollection = signer.borrow<&{NonFungibleToken.Receiver}>(from: ZeedzINO.CollectionStoragePath)
