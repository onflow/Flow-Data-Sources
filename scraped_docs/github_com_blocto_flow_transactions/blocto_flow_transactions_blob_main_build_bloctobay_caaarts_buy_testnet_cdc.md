# Source: https://github.com/blocto/flow-transactions/blob/main/build/BloctoBay/caaArts/buy.testnet.cdc
...
transaction(listingResourceID: UInt64, storefrontAddress: Address, buyPrice: UFix64) {
    ...
    prepare(signer: AuthAccount) {
        ...
        self.nftCollection = signer.borrow<&{NonFungibleToken.Receiver}>(from: CaaArts.CollectionStoragePath)
