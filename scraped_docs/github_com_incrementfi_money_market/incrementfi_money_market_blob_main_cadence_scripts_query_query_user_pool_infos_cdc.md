# Source: https://github.com/IncrementFi/Money-Market/blob/main/cadence/scripts/Query/query_user_pool_infos.cdc
...
access(all) fun main(userAddr: Address, comptrollerAddr: Address): {Address: AnyStruct} {
