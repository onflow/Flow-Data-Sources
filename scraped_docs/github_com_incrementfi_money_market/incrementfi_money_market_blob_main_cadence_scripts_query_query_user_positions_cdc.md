# Source: https://github.com/IncrementFi/Money-Market/blob/main/cadence/scripts/Query/query_user_positions.cdc
...
access(all) fun main(userAddrs: [Address], comptrollerAddr: Address): {Address: [String;3]} {
