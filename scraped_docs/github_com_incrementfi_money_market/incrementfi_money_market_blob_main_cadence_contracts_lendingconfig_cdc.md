# Source: https://github.com/IncrementFi/Money-Market/blob/main/cadence/contracts/LendingConfig.cdc
...
*/
access(all) contract LendingConfig {
    /// TwoSegmentsInterestRateModel.InterestRateModelPublicPath
    access(all) var InterestRateModelPublicPath: PublicPath
    /// SimpleOracle.OraclePublicPath
    access(all) var OraclePublicPath: PublicPath
    /// SimpleOracle.UpdaterPublicPath
    access(all) var UpdaterPublicPath: PublicPath
    /// value taken from LendingComptroller.ComptrollerPublicPath
    access(all) var ComptrollerPublicPath: PublicPath
    /// value taken from LendingComptroller.UserCertificateStoragePath
    access(all) var UserCertificateStoragePath: StoragePath
    /// value taken from LendingPool.PoolPublicPublicPath
    access(all) var PoolPublicPublicPath: PublicPath
