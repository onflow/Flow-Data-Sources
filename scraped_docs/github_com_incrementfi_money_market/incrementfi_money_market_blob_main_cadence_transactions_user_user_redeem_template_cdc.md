# Source: https://github.com/IncrementFi/Money-Market/blob/main/cadence/transactions/User/user_redeem_template.cdc
...
transaction(amountUnderlyingToRedeem: UFix64) {
    ...
    execute {
        let redeemedVault <- LendingPool.redeemUnderlying(userCertificate: self.userCertificate, numUnderlyingToRedeem: amountUnderlyingToRedeem)
