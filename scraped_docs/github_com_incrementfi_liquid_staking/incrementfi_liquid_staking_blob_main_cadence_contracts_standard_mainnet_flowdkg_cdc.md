# Source: https://github.com/IncrementFi/Liquid-Staking/blob/main/cadence/contracts/standard/mainnet/FlowDKG.cdc
        ...
        access(all) fun sendFinalSubmission(_ submission: [String?]) {
            ...
            while finalSubmissionIndex <= FlowDKG.uniqueFinalSubmissions.length {
                ...
                if FlowDKG.submissionsEqual(existingSubmission, submission) {
                    FlowDKG.uniqueFinalSubmissionCount[finalSubmissionIndex] = FlowDKG.uniqueFinalSubmissionCount[finalSubmissionIndex]! + 1
                    break
                }
