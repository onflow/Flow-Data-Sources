# Source: https://github.com/IncrementFi/Liquid-Staking/blob/main/cadence/transactions/test/unstake_in_collection.cdc
...
transaction(id: String, delegatorID: UInt32, amount: UFix64) {
    prepare(account: auth(BorrowValue) &Account) {
        ...
        stakingCollectionRef.requestUnstaking(nodeID: id, delegatorID: delegatorID, amount: amount)      
    }
}
```