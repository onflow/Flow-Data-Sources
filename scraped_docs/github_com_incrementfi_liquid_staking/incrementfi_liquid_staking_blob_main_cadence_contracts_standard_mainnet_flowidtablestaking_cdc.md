# Source: https://github.com/IncrementFi/Liquid-Staking/blob/main/cadence/contracts/standard/mainnet/FlowIDTableStaking.cdc
...
access(all) contract FlowIDTableStaking {
    ...
    /// The total amount of tokens that will be paid as rewards during the current epoch
