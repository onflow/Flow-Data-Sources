# Source: https://github.com/dapperlabs/studio-platform-smart-contracts/blob/main/locked-nft/contracts/ExampleNFT.cdc
...
access(all) contract ExampleNFT: NonFungibleToken {
    ...
    /// Public path for the collection; not part of the standard but useful for NFL-related contracts, which continue to have a public path defined at the contract level (added prior to Cadence 1.0/NFT v2.0)
    access(all) let CollectionPublicPath: PublicPath

    /// Storage path for the collection; not part of the standard but useful for NFL-related contracts, which continue to have a storage path defined at the contract level (added prior to Cadence 1.0/NFT v2.0)
