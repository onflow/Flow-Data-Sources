# Source: https://github.com/OurThinkTank/Flow/blob/main/contracts/GL_BridgeTest_NFT.cdc
        ...
        pub fun resolveView(_ view: Type): AnyStruct? {
            switch view {
                ...
                case Type<MetadataViews.ExternalURL>():
                    return MetadataViews.ExternalURL(GL_BridgeTest_NFT.getSetMetadataByField(setId: self.setId, field: "external_url")!.concat("tokens/").concat(self.id.toString()))    
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/GL_BridgeTest_NFT/square.png"
                        ),
                        mediaType: "image/png"
                    )
                    let bannerImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/GL_BridgeTest_NFT/banner.png"
                        ),
                        mediaType: "image/png"
                    )
                    return MetadataViews.NFTCollectionDisplay(
                        name: GL_BridgeTest_NFT.getSetMetadataByField(setId: self.setId, field: "name")!,
                        description: GL_BridgeTest_NFT.getSetMetadataByField(setId: self.setId, field: "description")!,
                        externalURL: MetadataViews.ExternalURL(GL_BridgeTest_NFT.getSetMetadataByField(setId: self.setId, field: "external_url")!.concat("tokens/").concat(self.id.toString())),
