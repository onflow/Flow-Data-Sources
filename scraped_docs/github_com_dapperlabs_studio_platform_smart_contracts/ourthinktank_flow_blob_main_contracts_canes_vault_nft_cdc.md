# Source: https://github.com/OurThinkTank/Flow/blob/main/contracts/Canes_Vault_NFT.cdc
        ...
        pub fun resolveView(_ view: Type): AnyStruct? {
            switch view {
                ...
                case Type<MetadataViews.ExternalURL>():
                    return MetadataViews.ExternalURL(Canes_Vault_NFT.getSetMetadataByField(setId: self.setId, field: "external_url")!.concat("tokens/").concat(self.id.toString()))    
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/Canes_Vault_NFT/square.png"
                        ),
                        mediaType: "image/png"
                    )
                    let bannerImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/Canes_Vault_NFT/banner.png"
                        ),
                        mediaType: "image/png"
                    )
                    return MetadataViews.NFTCollectionDisplay(
                        name: Canes_Vault_NFT.getSetMetadataByField(setId: self.setId, field: "name")!,
                        description: Canes_Vault_NFT.getSetMetadataByField(setId: self.setId, field: "description")!,
                        externalURL: MetadataViews.ExternalURL(Canes_Vault_NFT.getSetMetadataByField(setId: self.setId, field: "external_url")!.concat("tokens/").concat(self.id.toString())),
                        squareImage: squareImage,
                        bannerImage: bannerImage,
                        socials: {
                            "youtube": MetadataViews.ExternalURL("https://www.youtube.com/CanesAllAccess"),
                            "twitter": MetadataViews.ExternalURL("https://www.twitter.com/CanesVault"),
                            "instagram": MetadataViews.ExternalURL("https://www.instagram.com/CanesVault"),
                            "facebook": MetadataViews.ExternalURL("https://www.facebook.com/MiamiHurricanes")
                        }
                    )
