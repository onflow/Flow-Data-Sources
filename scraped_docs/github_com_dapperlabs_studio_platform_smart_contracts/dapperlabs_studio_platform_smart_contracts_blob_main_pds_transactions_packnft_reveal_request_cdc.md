# Source: https://github.com/dapperlabs/studio-platform-smart-contracts/blob/main/pds/transactions/packNFT/reveal_request.cdc
...
transaction(revealID: UInt64, openRequest: Bool) {
    prepare(owner: auth(BorrowValue) &Account) {
        ...
        collectionRef.emitRevealRequestEvent(id: revealID, openRequest: openRequest)
    }
}
