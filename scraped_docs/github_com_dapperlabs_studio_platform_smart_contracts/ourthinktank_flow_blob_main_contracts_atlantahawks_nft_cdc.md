# Source: https://github.com/OurThinkTank/Flow/blob/main/contracts/AtlantaHawks_NFT.cdc
        ...
        pub fun resolveView(_ view: Type): AnyStruct? {
            switch view {
                ...
                case Type<MetadataViews.ExternalURL>():
                    return MetadataViews.ExternalURL(AtlantaHawks_NFT.getSetMetadataByField(setId: self.setId, field: "external_url")!.concat("tokens/").concat(self.id.toString()))    
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    let squareImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/AtlantaHawks_NFT/square.png"
                        ),
                        mediaType: "image/png"
                    )
                    let bannerImage = MetadataViews.Media(
                        file: MetadataViews.HTTPFile(
                            url: "https://media.gigantik.io/AtlantaHawks_NFT/banner.png"
                        ),
                        mediaType: "image/png"
                    )
                    return MetadataViews.NFTCollectionDisplay(
                        name: AtlantaHawks_NFT.getSetMetadataByField(setId: self.setId, field: "name")!,
                        description: AtlantaHawks_NFT.getSetMetadataByField(setId: self.setId, field: "description")!,
                        externalURL: MetadataViews.ExternalURL(AtlantaHawks_NFT.getSetMetadataByField(setId: self.setId, field: "external_url")!.concat("tokens/").concat(self.id.toString())),
                        squareImage: squareImage,
                        bannerImage: bannerImage,
                        socials: {
                            "facebook": MetadataViews.ExternalURL("https://www.facebook.com/atlhawks"),
                            "twitter": MetadataViews.ExternalURL("https://twitter.com/atlhawks"),
                            "instagram": MetadataViews.ExternalURL("https://www.instagram.com/atlhawks")
                        }
                    )
