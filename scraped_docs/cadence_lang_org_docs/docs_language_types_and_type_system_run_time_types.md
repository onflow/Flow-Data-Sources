# Source: https://cadence-lang.org/docs/language/types-and-type-system/run-time-types
...
Intersection Types](/docs/language/types-and-type-system/intersection-types)[Next
