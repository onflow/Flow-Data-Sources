# Source: https://github.com/Flowtyio/lost-and-found/blob/main/scripts/lost-and-found/check_ticket_item.cdc

```
import "LostAndFound"

access(all) fun main(addr: Address, ticketID: UInt64, ticketTypeIdentifier: String): Bool {
