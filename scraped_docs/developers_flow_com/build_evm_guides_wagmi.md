# Source: https://developers.flow.com/build/evm/guides/wagmi
...
This step relies on an already deployed HelloWorld contract. See [Using Remix](/build/evm/guides/remix) to deploy a smart contract on flow evm blockchain.
...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/build/evm/guides/wagmi.md)

Last updated on **Aug 21, 2025** by **Brian Doyle**

[Previous

Rainbowkit](/build/evm/guides/rainbowkit)[Next
