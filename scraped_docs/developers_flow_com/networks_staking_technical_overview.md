...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/networks/staking/06-technical-overview.md)Last updated on **Jan 14, 2025** by **Giovanni Sanchez**[PreviousEpoch Scripts and Events](/networks/staking/epoch-scripts-events)[NextStaking Scripts and Events](/networks/staking/staking-scripts-events)
###### Rate this page
