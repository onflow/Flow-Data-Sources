# Source: https://developers.flow.com/tutorials/use-AI-to-build-on-flow
...
Tutorial: [Use Flow Knowledge Base in Cursor](/tutorials/use-AI-to-build-on-flow/cursor)
...
Tutorial: [Use Flow Knowledge Base in ChatGPT](/tutorials/use-AI-to-build-on-flow/chatgpt)
...
Tutorial: [Data Sources](/tutorials/use-AI-to-build-on-flow/flow-data-sources)
...
Tutorial: [Eliza on Flow](/tutorials/use-AI-to-build-on-flow/eliza)
...
Tutorial: [Build AI Agents with AgentKit](/tutorials/use-AI-to-build-on-flow/agentkit-flow-guide)
...
Tutorial: [Flow MCP](/tutorials/use-AI-to-build-on-flow/mcp)
...
Tutorial: [Cadence Rules](/tutorials/use-AI-to-build-on-flow/cadence-rules)
...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tutorials/use-AI-to-build-on-flow/index.md)

Last updated on **Aug 11, 2025** by **0xLisanAlGaib**

[Previous

Flow Blockchain 101](/tutorials/flow-101)[Next
