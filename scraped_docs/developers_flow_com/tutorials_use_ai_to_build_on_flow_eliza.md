# Source: https://developers.flow.com/tutorials/use-AI-to-build-on-flow/eliza
...
* [Use AI To Build On Flow](/tutorials/use-AI-to-build-on-flow)
  ...
  + [Eliza on Flow](/tutorials/use-AI-to-build-on-flow/eliza)
    ...
    - [Eliza Plugin Guide](/tutorials/use-AI-to-build-on-flow/eliza/build-plugin)
...
To create a new plugin **for your own business**, you can refer to the [plugin development guide](/tutorials/use-AI-to-build-on-flow/eliza/build-plugin).
...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tutorials/use-AI-to-build-on-flow/eliza/index.md)

Last updated on **Aug 11, 2025** by **0xLisanAlGaib**

[Previous

Cadence Rules](/tutorials/use-AI-to-build-on-flow/cadence-rules)[Next
