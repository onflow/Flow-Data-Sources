...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/networks/node-ops/node-operation/node-roles.md)Last updated on **Jan 22, 2025** by **Chase Fleming**[PreviousNode Provisioning](/networks/node-ops/node-operation/node-provisioning)[NextNode Setup](/networks/node-ops/node-operation/node-setup)
###### Rate this page
