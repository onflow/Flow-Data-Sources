# Source: https://developers.flow.com/protocol/access-onchain-data
...
More information on accounts can be found [here](/build/cadence/basics/accounts).
...
Managing disk space](/protocol/node-ops/node-operation/reclaim-disk)[Next
