# Source: https://developers.flow.com/tools/clients/fcl-js/packages-docs/fcl/script
...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/clients/fcl-js/packages-docs/fcl/script.md)

Last updated on **Jul 25, 2025** by **Jordan Ribbink**

[Previous

sansPrefix](/tools/clients/fcl-js/packages-docs/fcl/sansPrefix)[Next
