# Source: https://developers.flow.com/build/cadence/advanced-concepts/scaling
...
* * Cadence* Advanced Concepts* Scaling Transactions from a Single Account
...
VRF (Randomness) in Cadence](/build/cadence/advanced-concepts/randomness)[Next
