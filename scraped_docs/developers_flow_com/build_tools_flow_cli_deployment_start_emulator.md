...
* * [Tools & SDKs](/build/tools)* [Flow CLI](/build/tools/flow-cli)* Deploy Project* Start Emulator
...
* [Initial Configuration](#initial-configuration)* [Starting the Emulator](#starting-the-emulator)
    + [Example Output](#example-output)* [Customizing the Emulator](#customizing-the-emulator)* [Learn More](#learn-more)
