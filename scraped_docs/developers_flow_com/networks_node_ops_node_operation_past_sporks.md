...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/networks/node-ops/node-operation/past-sporks.md)Last updated on **Jan 27, 2025** by **j pimmel**[PreviousNode Setup](/networks/node-ops/node-operation/node-setup)[NextNetwork Upgrade (Spork) Process](/networks/node-ops/node-operation/spork)
###### Rate this page
