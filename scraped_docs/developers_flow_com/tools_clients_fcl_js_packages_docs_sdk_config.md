# Source: https://developers.flow.com/tools/clients/fcl-js/packages-docs/sdk/config
...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/clients/fcl-js/packages-docs/sdk/config.md)

Last updated on **Jul 25, 2025** by **Jordan Ribbink**

[Previous

cdc](/tools/clients/fcl-js/packages-docs/sdk/cdc)[Next
