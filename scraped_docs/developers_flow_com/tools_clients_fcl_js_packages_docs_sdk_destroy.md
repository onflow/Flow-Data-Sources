# Source: https://developers.flow.com/tools/clients/fcl-js/packages-docs/sdk/destroy
...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/clients/fcl-js/packages-docs/sdk/destroy.md)

Last updated on **Jul 25, 2025** by **Jordan Ribbink**

[Previous

decode](/tools/clients/fcl-js/packages-docs/sdk/decode)[Next
