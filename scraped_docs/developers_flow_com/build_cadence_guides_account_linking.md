# Source: https://developers.flow.com/build/cadence/guides/account-linking
...
* [Cadence](/build/cadence/getting-started)
  ...
  + [Guides](/build/cadence/guides/account-linking)
    ...
    - [Account Linking (FLIP 72)](/build/cadence/guides/account-linking)
      ...
      * [Building Walletless Applications Using Child Accounts](/build/cadence/guides/account-linking/child-accounts)
      * [Working With Parent Accounts](/build/cadence/guides/account-linking/parent-accounts)
...
contract](/build/cadence/guides/account-linking/parent-accounts) that helps custodial applications regulate access while enabling parent accounts to
...
Learn more about it in the [Hybrid Custody documentation](/build/cadence/guides/account-linking/parent-accounts).

### Guides[​](#guides "Direct link to Guides")

* [Building Walletless Applications Using Child Accounts](/build/cadence/guides/account-linking/child-accounts) covers how apps can leverage Account
  Linking to create a seamless user experience and enable future self-custody.
* [Working With Parent Accounts](/build/cadence/guides/account-linking/parent-accounts) covers features enabled by the core `HybridCustody` contract to
...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/build/cadence/guides/account-linking/index.md)
