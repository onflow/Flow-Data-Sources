...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/flow-cli/accounts/create-accounts.md)Last updated on **Jan 27, 2025** by **j pimmel**[PreviousGet an Account](/tools/flow-cli/accounts/get-accounts)[NextDeploy a Contract](/tools/flow-cli/accounts/account-add-contract)
###### Rate this page
