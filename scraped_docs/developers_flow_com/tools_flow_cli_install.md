...
**Windows**
 ...
 `_10iex "& { $(irm 'https://raw.githubusercontent.com/onflow/flow-cli/master/install.ps1') }"`[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/flow-cli/install.md)Last updated on **Dec 24, 2024** by **Jerome P**[PreviousFlow CLI](/tools/flow-cli)[NextSuper Commands](/tools/flow-cli/super-commands)
###### Rate this page
