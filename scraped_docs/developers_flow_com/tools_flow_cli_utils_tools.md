...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/flow-cli/utils/tools.md)Last updated on **Jan 3, 2025** by **Brian Doyle**[PreviousSnapshot Save](/tools/flow-cli/utils/snapshot-save)[NextDependency Manager](/tools/flow-cli/dependency-manager)
###### Rate this page
