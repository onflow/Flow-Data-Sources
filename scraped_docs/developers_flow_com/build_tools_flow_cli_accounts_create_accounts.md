# Source: https://developers.flow.com/build/tools/flow-cli/accounts/create-accounts
...
* * [Tools & SDKs](/build/tools)* [Flow CLI](/build/tools/flow-cli)* Accounts* Create an Account
...
Get an Account](/build/tools/flow-cli/accounts/get-accounts)[Next
