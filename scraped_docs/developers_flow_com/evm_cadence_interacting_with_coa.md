...
As covered in the [Batched EVM transactions walkthrough](/evm/cadence/batched-evm-transactions), you can script multiple EVM
...
Check out the [Batched EVM Transactions walkthrough](/evm/cadence/batched-evm-transactions) for details on transaction batching
using Cadence.
