# Source: https://developers.flow.com/protocol/governance
...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/protocol/governance.md)

Last updated on **Aug 22, 2025** by **Brian Doyle**

[Previous

Common errors](/protocol/access-onchain-data/websockets-stream-api/common-errors)[Next
...
* [Participation](#participation)* [Token Holder Rights](#token-holder-rights)* [Process](#process)
      + [Timing](#timing)* [Protocol Set Parameters](#protocol-set-parameters)* [Early Governance of the Protocol](#early-governance-of-the-protocol)
