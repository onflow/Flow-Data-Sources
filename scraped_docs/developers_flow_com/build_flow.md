...
* [Forte Network Upgrade](#forte-network-upgrade)
  + [What makes Forte Interesting](#what-makes-forte-interesting)
  + [Flow Actions: Protocol-native composability](#flow-actions-protocol-native-composability)
  + [Scheduled Transaction: Autonomous onchain execution](#scheduled-transaction-autonomous-onchain-execution)
  + [High-precision DeFi with 128-bit fixed-point types](#high-precision-defi-with-128-bit-fixed-point-types)
  + [WebAuthn and passkey support](#webauthn-and-passkey-support)
  + [AI-friendly Cadence errors](#ai-friendly-cadence-errors)
  + [Boosting Efficiency and Scalability](#boosting-efficiency-and-scalability)
  + [Protocol Autonomy](#protocol-autonomy)
