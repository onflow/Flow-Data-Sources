# Source: https://developers.flow.com/tools/clients/fcl-js/packages-docs/types

Type Definitions | Flow Developer Portal
...
### SdkTransport[​](#sdktransport "Direct link to SdkTransport")
...
### SubscriptionData[​](#subscriptiondata "Direct link to SubscriptionData")
...
### FvmErrorCode[​](#fvmerrorcode "Direct link to FvmErrorCode")
...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/clients/fcl-js/packages-docs/types/index.md)

Last updated on **Jul 25, 2025** by **Jordan Ribbink**

[Previous

why](/tools/clients/fcl-js/packages-docs/sdk/why)[Next
