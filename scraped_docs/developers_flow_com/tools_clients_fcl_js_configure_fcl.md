...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/clients/fcl-js/configure-fcl.md)Last updated on **Jan 3, 2025** by **Brian Doyle**[PreviousAuthentication](/tools/clients/fcl-js/authentication)[NextWallet Discovery](/tools/clients/fcl-js/discovery)
###### Rate this page
