...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/flow-cli/tests.md)Last updated on **Feb 5, 2025** by **Brian Doyle**[PreviousDependency Manager](/tools/flow-cli/dependency-manager)[NextCadence Linter](/tools/flow-cli/lint)
###### Rate this page
