...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/networks/node-ops/light-nodes/observer-node.md)Last updated on **Jan 18, 2025** by **j pimmel**[PreviousEVM Gateway Setup](/networks/node-ops/evm-gateway/evm-gateway-setup)[NextOperator FAQ](/networks/node-ops/node-operation/faq)
###### Rate this page
