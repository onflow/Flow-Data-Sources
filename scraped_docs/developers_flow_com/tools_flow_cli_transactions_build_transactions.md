...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/flow-cli/transactions/build-transactions.md)Last updated on **Dec 24, 2024** by **Jerome P**[PreviousGet a Transaction](/tools/flow-cli/transactions/get-transactions)[NextBuild a Complex Transaction](/tools/flow-cli/transactions/complex-transactions)
###### Rate this page
