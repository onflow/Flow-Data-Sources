# Source: https://developers.flow.com/networks/node-ops/access-onchain-data/evm-gateway/evm-gateway-setup
...
* [Node Ops](/networks/node-ops)
  + [Accessing On-chain Data](/networks/node-ops/access-onchain-data/access-nodes/access-node-setup)
    ...
    - [EVM Gateway](/networks/node-ops/access-onchain-data/evm-gateway/evm-gateway-setup)
      * [EVM Gateway Setup](/networks/node-ops/access-onchain-data/evm-gateway/evm-gateway-setup)
...
Ensure that the following ENV variables have been set. Add/update as required if your configuration differs from those listed.
 ...
 `_10# Set required environment variables_10export ACCESS_NODE_GRPC_HOST="access.mainnet.nodes.onflow.org:9000" # or access.devnet.nodes.onflow.org:9000 for testnet_10export FLOW_NETWORK_ID="flow-mainnet" # or flow-testnet_10export INIT_CADENCE_HEIGHT="85981135" # 211176670 for testnet_10export COINBASE="${EVM_ADDRESS_WITHOUT_0x}"_10export COA_ADDRESS="${CADENCE_ACCOUNT_ADDRESS_WITHOUT_0x}"_10export COA_KEY="${CADENCE_ACCOUNT_PRIVATE_KEY_WITHOUT_0x}"_10export GAS_PRICE="100"`
...
**Create EVM Gateway service**
 ...
 `_29sudo tee <<EOF >/dev/null /etc/systemd/system/gateway.service_29[Unit]_29Description=Gateway daemon_29After=network-online.target_29_29[Service]_29User=$USER_29ExecStart=/usr/bin/evm-gateway \_29--access-node-grpc-host=$ACCESS_NODE_GRPC_HOST \_29--flow-network-id=$FLOW_NETWORK_ID \_29--init-cadence-height=$INIT_CADENCE_HEIGHT \_29--ws-enabled=true \_29--coinbase=$COINBASE \_29--coa-address=$COA_ADDRESS \_29--coa-key=$COA_KEY \_29--rate-limit=9999999 \_29--rpc-host=0.0.0.0 \_29--gas-price=$GAS_PRICE \_29--tx-state-validation=local-index_29Restart=always_29RestartSec=3_29LimitNOFILE=4096_29_29[Install]_29WantedBy=multi-user.target_29EOF_29_29cat /etc/systemd/system/gateway.service_29sudo systemctl enable gateway`
...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/networks/node-ops/access-onchain-data/evm-gateway/evm-gateway-setup.md)Last updated on **Dec 24, 2024** by **Jerome P**[PreviousAccess HTTP API ↗️](/networks/node-ops/access-onchain-data/access-nodes/accessing-data/access-http-api)[NextLight Node Setup](/networks/node-ops/access-onchain-data/light-nodes/observer-node)
###### Rate this page
