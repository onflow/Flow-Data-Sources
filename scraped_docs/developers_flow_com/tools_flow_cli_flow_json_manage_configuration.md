...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/flow-cli/flow.json/manage-configuration.md)Last updated on **Jan 27, 2025** by **j pimmel**[PreviousConfiguration](/tools/flow-cli/flow.json/configuration)[NextSecurity](/tools/flow-cli/flow.json/security)
###### Rate this page
