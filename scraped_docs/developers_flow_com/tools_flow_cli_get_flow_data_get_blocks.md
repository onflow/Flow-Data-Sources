...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/flow-cli/get-flow-data/get-blocks.md)Last updated on **Dec 24, 2024** by **Jerome P**[PreviousSecurity](/tools/flow-cli/flow.json/security)[NextGet Events](/tools/flow-cli/get-flow-data/get-events)
###### Rate this page
