...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/vscode-extension/index.md)Last updated on **Jan 7, 2025** by **Chase Fleming**[PreviousFlow Dev Wallet](/tools/flow-dev-wallet)[NextWallet Provider Spec](/tools/wallet-provider-spec)
###### Rate this page
