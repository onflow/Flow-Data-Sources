# Source: https://developers.flow.com/tutorials/use-AI-to-build-on-flow/chatgpt
...
This guide walks you through creating a **Custom GPT** using ChatGPT that can reference the [Flow Data Sources](/tutorials/use-AI-to-build-on-flow/flow-data-sources) file to answer questions.
...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tutorials/use-AI-to-build-on-flow/chatgpt/index.md)

Last updated on **Aug 11, 2025** by **0xLisanAlGaib**

[Previous

Contribute to Flow MCP](/tutorials/use-AI-to-build-on-flow/mcp/contribute-to-mcp)[Next
