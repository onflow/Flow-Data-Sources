# Source: https://developers.flow.com/build/tools/flow-cli/keys/generate-keys
...
* * [Tools & SDKs](/build/tools)* [Flow CLI](/build/tools/flow-cli)* Keys* Generate Keys
...
Funding a Testnet Account](/build/tools/flow-cli/accounts/account-fund)[Next
