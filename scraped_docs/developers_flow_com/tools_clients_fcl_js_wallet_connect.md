...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/clients/fcl-js/wallet-connect.md)Last updated on **Jan 10, 2025** by **Ali Serag**[PreviousSigning and Verifying Arbitrary Data](/tools/clients/fcl-js/user-signatures)[NextFlow Go SDK](/tools/clients/flow-go-sdk)
###### Rate this page
