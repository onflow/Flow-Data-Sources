...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/networks/staking/04-stake-slashing.md)Last updated on **Jan 7, 2025** by **Chase Fleming**[PreviousEpoch Preparation Protocol](/networks/staking/epoch-preparation)[NextEpoch Scripts and Events](/networks/staking/epoch-scripts-events)Documentation
