...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/flow-cli/accounts/account-add-contract.md)Last updated on **Feb 7, 2025** by **Josh Hannan**[PreviousCreate an Account](/tools/flow-cli/accounts/create-accounts)[NextUpdate a Contract](/tools/flow-cli/accounts/account-update-contract)
###### Rate this page
