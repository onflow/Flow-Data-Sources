# Source: https://developers.flow.com/blockchain-development-tutorials/tokens

Token Development and Registration | Flow Developer Portal
...
* [Cadence Token Development](#cadence-token-development)
  + [Creating a Fungible Token](#creating-a-fungible-token)
  + [Creating an NFT Contract](#creating-an-nft-contract)
  + [Register Your Assets in Cadence](#register-your-assets-in-cadence)
* [Flow EVM Token Development](#flow-evm-token-development)
  + [Register Your ERC20 Token](#register-your-erc20-token)
