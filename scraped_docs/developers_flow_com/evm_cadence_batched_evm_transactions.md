...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/evm/cadence/batched-evm-transactions.md)Last updated on **Jan 10, 2025** by **Brian Doyle**[PreviousDirect Calls to Flow EVM](/evm/cadence/direct-calls)[NextCross-VM Bridge](/evm/cadence/vm-bridge)
###### Rate this page
