...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/flow-cli/accounts/get-accounts.md)Last updated on **Dec 24, 2024** by **Jerome P**[PreviousSuper Commands](/tools/flow-cli/super-commands)[NextCreate an Account](/tools/flow-cli/accounts/create-accounts)
###### Rate this page
