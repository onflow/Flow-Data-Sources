...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/flow-cli/accounts/get-accounts.md)Last updated on **Jan 10, 2025** by **Ali Serag**[PreviousSuper Commands](/tools/flow-cli/super-commands)[NextCreate an Account](/tools/flow-cli/accounts/create-accounts)
###### Rate this page
