...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/flow-cli/accounts/get-accounts.md)Last updated on **Feb 5, 2025** by **Brian Doyle**[PreviousSuper Commands](/tools/flow-cli/super-commands)[NextCreate an Account](/tools/flow-cli/accounts/create-accounts)
###### Rate this page
