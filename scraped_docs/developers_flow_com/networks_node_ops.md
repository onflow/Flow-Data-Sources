...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/networks/node-ops/index.md)Last updated on **Jan 28, 2025** by **Giovanni Sanchez**[PreviousBasic Staking Guide (Deprecated)](/networks/staking/staking-guide)[NextAccess Node Setup](/networks/node-ops/access-nodes/access-node-setup)
###### Rate this page
