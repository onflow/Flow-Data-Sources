...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/flow-cli/boilerplate.md)Last updated on **Jan 23, 2025** by **Brian Doyle**[PreviousFlow Interaction Templates (FLIX)](/tools/flow-cli/flix)[NextData Collection](/tools/flow-cli/data-collection)
###### Rate this page
