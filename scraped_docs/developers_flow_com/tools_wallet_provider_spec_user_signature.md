...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/wallet-provider-spec/user-signature.md)Last updated on **Jan 10, 2025** by **Brian Doyle**[PreviousProvable Authn](/tools/wallet-provider-spec/provable-authn)
###### Rate this page
