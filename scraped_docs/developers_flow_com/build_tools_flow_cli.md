# Source: https://developers.flow.com/build/tools/flow-cli
...
* **Manage Contract Dependencies**: Use the [Dependency Manager](/build/tools/flow-cli/dependency-manager) to install and manage smart contract dependencies effortlessly, which simplifies the integration of external contracts into your project.
...
* **Interact with the [Flow Access API](/http-api)**: Automate complex workflows with configuration files and command-line scripting, which allows for greater flexibility in continuous integration (CI) or custom development tools.
...
To learn more about Flow CLI commands and how to use them, see the [Commands documentation](/build/tools/flow-cli/commands).
