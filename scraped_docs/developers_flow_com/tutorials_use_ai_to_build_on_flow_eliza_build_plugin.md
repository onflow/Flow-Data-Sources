# Source: https://developers.flow.com/tutorials/use-AI-to-build-on-flow/eliza/build-plugin
...
Please follow the [Quickstart Guide](/tutorials/use-AI-to-build-on-flow/eliza) to set up your development environment.
...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tutorials/use-AI-to-build-on-flow/eliza/build-plugin.md)

Last updated on **Aug 11, 2025** by **0xLisanAlGaib**

[Previous

Eliza on Flow](/tutorials/use-AI-to-build-on-flow/eliza)[Next
