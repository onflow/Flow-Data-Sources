# Source: https://developers.flow.com/protocol/flow-port/staking-guide
...
* * [Flow Port](/protocol/flow-port)* Flow Port Staking Guide
...
If you're new to the concepts of staking and delegating you can [read this guide](/protocol/staking) to learn more.
...
If you don't have this information, go [here](/protocol/node-ops/node-operation/node-bootstrap#step-1---run-genesis-bootstrap) for instructions on how to acquire it.
...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/protocol/flow-port/staking-guide.md)
...
* [First Step](#first-step)* [Stake a Node](#stake-a-node)
    + [Begin Staking](#begin-staking)* [Delegating](#delegating)
      + [Enter a Node Operator ID](#enter-a-node-operator-id)+ [Enter an amount](#enter-an-amount)* [Returning to Port](#returning-to-port)* [Re-staking](#re-staking)* [Withdraw your Rewards](#withdraw-your-rewards)
