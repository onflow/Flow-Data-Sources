...
Transaction content (`tx.cdc`):
 ...
 `_10transaction {_10 prepare(signer: &Account) {}_10 execute { ... }_10}`
...
Transaction content (`tx.cdc`):
 ...
 `_10transaction {_10 prepare(bob: &Account, charlie: &Account) {}_10 execute { ... }_10}`
...
Transaction content (`tx.cdc`):
 ...
 `_10transaction {_10 prepare(charlie: &Account) {}_10 execute { ... }_10}`
