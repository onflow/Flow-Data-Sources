...
Example transaction with multiple authorizers:
 ...
 `_10transaction {_10 prepare(authorizer1: auth(Capabilities) &Account, authorizer2: auth(Storage) &Account) { }_10}`
...
You can use the Flow CLI to get an existing transaction by ID:
 ...
 `_10flow transactions get 1ec90051e3bc74fc36cbd16fc83df08e463dda8f92e8e2193e061f9d41b2ad92 -n mainnet`
...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/build/basics/transactions.md)Last updated on **Feb 11, 2025** by **Chase Fleming**[PreviousAccounts](/build/basics/accounts)[NextScripts](/build/basics/scripts)
###### Rate this page
