...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/networks/node-ops/node-operation/guides/spork-practice.md)Last updated on **Feb 6, 2025** by **Brian Doyle**[PreviousGenesis Bootstrapping](/networks/node-ops/node-operation/guides/genesis-bootstrap)[NextStarting Your Nodes](/networks/node-ops/node-operation/guides/starting-nodes)
###### Rate this page
