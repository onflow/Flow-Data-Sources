...
### Install specific dependencies[​](#install-specific-dependencies "Direct link to Install specific dependencies")
...
### Install core contracts with simplified syntax[​](#install-core-contracts-with-simplified-syntax "Direct link to Install core contracts with simplified syntax")
...
### Install multiple dependencies[​](#install-multiple-dependencies "Direct link to Install multiple dependencies")
...
### Install all dependencies from an address[​](#install-all-dependencies-from-an-address "Direct link to Install all dependencies from an address")
...
### Install dependencies from `flow.json`[​](#install-dependencies-from-flowjson "Direct link to install-dependencies-from-flowjson")
...
* Dependencies function just like local contracts. You can add them to [`deployments` in your `flow.json`](/build/tools/flow-cli/deployment/deploy-project-contracts) and run `flow project deploy`. You can also import them in your scripts, transactions, and contracts (for example, `import "FlowToken"`).
...
* [`install`](#install)
  + [Install specific dependencies](#install-specific-dependencies)+ [Install core contracts with simplified syntax](#install-core-contracts-with-simplified-syntax)+ [Install multiple dependencies](#install-multiple-dependencies)+ [Install all dependencies from an address](#install-all-dependencies-from-an-address)+ [Install dependencies from `flow.json`](#install-dependencies-from-flowjson)+ [Example `flow.json` entry](#example-flowjson-entry)+ [Other things to note](#other-things-to-note)* [`discover`](#discover)* [`list`](#list)
