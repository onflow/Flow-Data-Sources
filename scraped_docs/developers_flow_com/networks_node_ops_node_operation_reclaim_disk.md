...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/networks/node-ops/node-operation/reclaim-disk.md)Last updated on **Dec 24, 2024** by **Jerome P**[PreviousProtocol State Bootstrapping](/networks/node-ops/node-operation/protocol-state-bootstrap)[NextAccess API](/networks/access-onchain-data)
###### Rate this page
