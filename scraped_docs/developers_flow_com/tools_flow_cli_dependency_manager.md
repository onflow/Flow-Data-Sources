...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/flow-cli/dependency-manager.md)Last updated on **Jan 14, 2025** by **Giovanni Sanchez**[PreviousDevelopment Tools](/tools/flow-cli/utils/tools)[NextRunning Cadence Tests](/tools/flow-cli/tests)
###### Rate this page
