...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/flow-cli/dependency-manager.md)Last updated on **Jan 3, 2025** by **Brian Doyle**[PreviousDevelopment Tools](/tools/flow-cli/utils/tools)[NextRunning Cadence Tests](/tools/flow-cli/tests)
###### Rate this page
