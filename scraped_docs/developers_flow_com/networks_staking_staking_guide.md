...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/networks/staking/15-staking-guide.md)Last updated on **Feb 6, 2025** by **Brian Doyle**[PreviousStaking Collection Guide](/networks/staking/staking-collection)[NextNode Operations](/networks/node-ops)
###### Rate this page
