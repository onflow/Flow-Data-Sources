...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/flow-cli/utils/snapshot-save.md)Last updated on **Jan 28, 2025** by **Giovanni Sanchez**[PreviousVerify Signature](/tools/flow-cli/utils/signature-verify)[NextDevelopment Tools](/tools/flow-cli/utils/tools)
###### Rate this page
