# Source: https://developers.flow.com/protocol/staking/staking-collection
...
using [the `FlowIDTableStaking` contract](/build/cadence/core-contracts/staking-contract-reference)
and [the `FlowStakingCollection` contract.](/build/cadence/core-contracts/staking-collection)
...
To set up a Staking Collection, you must run the **Setup Staking Collection** ([SCO.01](/build/cadence/core-contracts/staking-collection)) transaction.
