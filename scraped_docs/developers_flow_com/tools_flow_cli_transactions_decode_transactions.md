...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/flow-cli/transactions/decode-transactions.md)Last updated on **Jan 3, 2025** by **Brian Doyle**[PreviousSend Signed Transaction](/tools/flow-cli/transactions/send-signed-transactions)[NextInitialize Configuration](/tools/flow-cli/flow.json/initialize-configuration)
###### Rate this page
