# Source: https://developers.flow.com/tools/clients/fcl-js/packages-docs/fcl/invariant
...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/clients/fcl-js/packages-docs/fcl/invariant.md)

Last updated on **Jul 25, 2025** by **Jordan Ribbink**

[Previous

getTransactionStatus](/tools/clients/fcl-js/packages-docs/fcl/getTransactionStatus)[Next
