# Source: https://developers.flow.com/build/evm/guides/web3-js
...
We recommend deploying your own contract, which can be done using [Hardhat](/build/evm/guides/hardhat) or [Remix](/build/evm/guides/remix).
...
The ABI for this contract can be generated using the [`solc` compiler](https://docs.soliditylang.org/en/latest/installing-solidity.html), or another tool such as [Hardhat](/build/evm/guides/hardhat) or [Remix](/build/evm/guides/remix).
...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/build/evm/guides/web3-js.md)

Last updated on **Aug 21, 2025** by **Brian Doyle**

[Previous

Ethers](/build/evm/guides/ethers)[Next
