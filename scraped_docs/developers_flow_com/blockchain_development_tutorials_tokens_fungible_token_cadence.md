# Source: https://developers.flow.com/blockchain-development-tutorials/tokens/fungible-token-cadence
...
* * [Token Development and Registration](/blockchain-development-tutorials/tokens)* Creating a Fungible Token
