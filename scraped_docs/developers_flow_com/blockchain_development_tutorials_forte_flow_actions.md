# Source: https://developers.flow.com/blockchain-development-tutorials/forte/flow-actions
...
* * [Forte Network Upgrade](/blockchain-development-tutorials/forte)* Flow Actions
...
* **[Flow Actions Transaction](/blockchain-development-tutorials/forte/flow-actions/flow-actions-transaction)** - Learn how to create and execute Flow Actions transactions for automated DeFi workflows.
* **[Connectors](/blockchain-development-tutorials/forte/flow-actions/connectors)** - Understand how connectors bridge standardized Flow Actions interfaces with different DeFi protocols.
* **[Basic Combinations](/blockchain-development-tutorials/forte/flow-actions/basic-combinations)** - Learn how to combine Flow Actions to create new workflows.
...
Forte Network Upgrade](/blockchain-development-tutorials/forte)[Next
