...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/flow-cli/transactions/send-transactions.md)Last updated on **Jan 23, 2025** by **Brian Doyle**[PreviousExecute a Script](/tools/flow-cli/scripts/execute-scripts)[NextGet a Transaction](/tools/flow-cli/transactions/get-transactions)
###### Rate this page
