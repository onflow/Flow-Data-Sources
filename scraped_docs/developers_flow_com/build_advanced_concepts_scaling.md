...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/build/advanced-concepts/scaling.md)Last updated on **Feb 11, 2025** by **Chase Fleming**[PreviousVRF (Randomness) in Cadence](/build/advanced-concepts/randomness)[NextAccount Linking (FLIP 72)](/build/guides/account-linking)
###### Rate this page
