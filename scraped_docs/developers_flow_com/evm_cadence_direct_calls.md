...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/evm/cadence/direct-calls.md)Last updated on **Jan 22, 2025** by **Chase Fleming**[PreviousInteracting with COAs](/evm/cadence/interacting-with-coa)[NextBatched EVM Transactions](/evm/cadence/batched-evm-transactions)
###### Rate this page
