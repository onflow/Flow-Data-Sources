...
* * [Tools & SDKs](/build/tools)* [Flow CLI](/build/tools/flow-cli)* Install Instructions
...
* [macOS](#macos)
  + [Homebrew](#homebrew)+ [From a pre-built binary](#from-a-pre-built-binary)* [Linux](#linux)
    + [From a pre-built binary](#from-a-pre-built-binary-1)+ [Install a specific version](#install-a-specific-version)* [Windows](#windows)
