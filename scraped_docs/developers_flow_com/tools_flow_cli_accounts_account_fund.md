...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/flow-cli/accounts/account-fund.md)Last updated on **Jan 7, 2025** by **Chase Fleming**[PreviousAccount Staking Info](/tools/flow-cli/accounts/account-staking-info)[NextGenerate Keys](/tools/flow-cli/keys/generate-keys)
###### Rate this page
