# Source: https://developers.flow.com/build/tools/wallet-provider-spec/custodial
...
* * [Tools & SDKs](/build/tools)* [Wallet Provider Spec](/build/tools/wallet-provider-spec)* Introduction
...
* `redirect` *(optional)* -- where to redirect after the authentication challenge is complete.
...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/build/tools/wallet-provider-spec/custodial.md)

Last updated on **Dec 17, 2025** by **cshannon1218**

[Previous

Authorization Function](/build/tools/wallet-provider-spec/authorization-function)[Next
