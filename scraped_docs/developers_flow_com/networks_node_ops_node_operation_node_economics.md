...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/networks/node-ops/node-operation/node-economics.md)Last updated on **Jan 27, 2025** by **j pimmel**[PreviousNode Bootstrapping](/networks/node-ops/node-operation/node-bootstrap)[NextNode Migration](/networks/node-ops/node-operation/node-migration)
###### Rate this page
