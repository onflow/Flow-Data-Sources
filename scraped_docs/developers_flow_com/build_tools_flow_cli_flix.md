# Source: https://developers.flow.com/build/tools/flow-cli/flix
...
* * [Tools & SDKs](/build/tools)* [Flow CLI](/build/tools/flow-cli)* Flow Interaction Templates (FLIX)
...
Queries can be a FLIX `url` or `path` to a local FLIX file. This command leverages [FCL](/build/tools/clients/fcl-js) which will execute FLIX cadence code. Package files can be generated in JavaScript or TypeScript.
