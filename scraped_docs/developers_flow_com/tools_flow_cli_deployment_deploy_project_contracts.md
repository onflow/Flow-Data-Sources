...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/flow-cli/deployment/deploy-project-contracts.md)Last updated on **Feb 6, 2025** by **Brian Doyle**[PreviousAdd Project Contracts](/tools/flow-cli/deployment/project-contracts)[NextCreate Emulator Snapshot](/tools/flow-cli/deployment/emulator-snapshot)
###### Rate this page
