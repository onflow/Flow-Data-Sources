# Source: https://developers.flow.com/protocol/staking/epoch-preparation
...
* * [Staking and Epochs](/protocol/staking)* Epoch Preparation Protocol
...
For each Epoch, there is a [Staking Auction](/protocol/staking/technical-overview) in which new potential node operators may submit Staking Commitments.
...
Specifically, it is allowed to emit [Service Events](/protocol/staking/epoch-scripts-events#monitor-epoch-service-events),
...
* As part of the execution result for the last block of the staking auction,
  ...
  See the [Epoch Setup Event Documentation](/protocol/staking/epoch-scripts-events#flowepochepochsetup)
...
See the [Epoch Commit Event Documentation](/protocol/staking/epoch-scripts-events#flowepochepochcommit)
...
See the [epoch scripts and events document](/protocol/staking/epoch-scripts-events#introduction) for detailed documentation about
you can use scripts events to learn information about the state of the epoch contracts.

[Edit this page](https://github.com/onflow/docs/tree/main/docs/protocol/staking/04-epoch-preparation.md)

Last updated on **Aug 22, 2025** by **Brian Doyle**

[Previous

Epoch and Reward Schedule](/protocol/staking/schedule)[Next
...
* [Epochs Overview](#epochs-overview)* [Epoch Length](#epoch-length)* [Phase Transitions](#phase-transitions)* [Phase 0: Staking Auction](#phase-0-staking-auction)
        + [**Protocol Directives:**](#protocol-directives)* [Phase 1: Epoch Setup](#phase-1-epoch-setup)
          + [**Protocol Directives:**](#protocol-directives-1)* [Phase 2: Epoch Committed](#phase-2-epoch-committed)
