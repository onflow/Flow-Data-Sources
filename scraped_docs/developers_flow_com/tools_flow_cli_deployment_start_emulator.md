...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/flow-cli/deployment/start-emulator.md)Last updated on **Jan 27, 2025** by **j pimmel**[PreviousDerive Public Key](/tools/flow-cli/keys/derive-keys)[NextAdd Project Contracts](/tools/flow-cli/deployment/project-contracts)
###### Rate this page
