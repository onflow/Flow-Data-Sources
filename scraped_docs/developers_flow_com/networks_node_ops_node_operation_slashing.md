...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/networks/node-ops/node-operation/slashing.md)Last updated on **Feb 5, 2025** by **Brian Doyle**[PreviousUpcoming Sporks](/networks/node-ops/node-operation/upcoming-sporks)[NextNode Providers](/networks/node-ops/node-operation/node-providers)
###### Rate this page
