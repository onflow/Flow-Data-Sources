...
[Edit this page](https://github.com/onflow/docs/tree/main/docs/tools/flow-cli/transactions/get-transactions.md)Last updated on **Dec 24, 2024** by **Jerome P**[PreviousSend a Transaction](/tools/flow-cli/transactions/send-transactions)[NextBuild a Transaction](/tools/flow-cli/transactions/build-transactions)
###### Rate this page
