# Source: https://developers.flow.com/build/cadence/basics/accounts
...
Are you an EVM developer looking for information about EVM Accounts on Flow? If so, check out the EVM specific documentation [here](/build/evm/accounts)
...
Due to the storage restrictions, there is a maximum available balance that user can withdraw from the wallet. The core contract [`FlowStorageFees`](/build/cadence/core-contracts/flow-fees#flowstoragefees) provides a function to retrieve that value:
...
Collections](/build/cadence/basics/collections)[Next
