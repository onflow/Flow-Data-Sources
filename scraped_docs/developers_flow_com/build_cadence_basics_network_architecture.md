# Source: https://developers.flow.com/build/cadence/basics/network-architecture
...
* * Cadence* Basics* Network Architecture ↗️

# Network Architecture ↗️

;

[Edit this page](https://github.com/onflow/docs/tree/main/docs/build/cadence/basics/network-architecture.md)

Last updated on **Aug 22, 2025** by **Brian Doyle**

[Previous

Differences vs. EVM](/build/cadence/differences-vs-evm)[Next
